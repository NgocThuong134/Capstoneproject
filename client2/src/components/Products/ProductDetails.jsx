        ...
        <div className={`${styles.section} w-[90%] 800px:w-[80%]`}>
          <div className="w-full py-5">
            <div className="block w-full 800px:flex">
             ...
             {/* Thêm vào giỏ hàng */}
            <div
              className={`${styles.button} bg-gradient-to-r from-blue-600 to-blue-500 !mt-6 !rounded-lg shadow-md flex items-center justify-center py-1 px-2 w-full max-w-xs hover:bg-blue-700 transition duration-200 transform hover:scale-105`}
