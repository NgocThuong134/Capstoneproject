  ...
  const removeFromCartHandler = (data) => {
    toast(
      <div className="p-4 bg-white rounded-lg shadow-md">
        <p className="text-lg font-semibold text-gray-800">Bạn có chắc chắn muốn xóa sản phẩm này?</p>
        <div className="flex justify-end mt-4">
          <button
            className="px-4 py-2 bg-red text-white rounded-lg mr-2 hover:bg-red-700 transition-colors duration-200"
            onClick={() => {
